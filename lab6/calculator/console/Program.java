...
public class Program {
  ...
  private AbstractValueParser inputValueParser() {
    ...
    if (
      choise >= 1 && choise <= valueParsers.length
    ) return valueParsers[choise - 1]; else {
      System.out.println("�������� �����!");
  ...
  private void showChoises() {
    System.out.println("��� ����� ������� ��� ������. ��������� ��������:");
    for (int i = 0; i < valueParsers.length; i++) System.out.println(
      "  " + (i + 1) + ". " + valueParsers[i].getDatatypeName()
    );
  }
